...
(function($) {
  ...
  function Plugin(element, options) {
    ...
    this.configObsAttributes = [{"field":null,"label":""},{"field":null,"label":""}];
...
function nonFieldColumns() {
  ...
  var timeSeriesAttributes = [{"field":"COMMENT_TS","label":"footnote"},{"field":"DATA_LAST_UPDATE","label":"metadata_fields.national_data_update_url"}];
  ...
  var observationAttributes = [{"field":null,"label":""},{"field":null,"label":""}];
  if (observationAttributes && observationAttributes.length > 0) {
...
function prepareDataForDataset(years, rows, allObservationAttributes) {
  ...
  var configObsAttributes = [{"field":null,"label":""},{"field":null,"label":""}];
...
function inputEdges(edges) {
  ...
  var configuredObservationAttributes = [{"field":null,"label":""},{"field":null,"label":""}];
...
function getTimeSeriesAttributes(rows) {
  ...
  var timeSeriesAttributes = [],
      possibleAttributes = [{"field":"COMMENT_TS","label":"footnote"},{"field":"DATA_LAST_UPDATE","label":"metadata_fields.national_data_update_url"}],
      firstRow = rows[0],
...
function getAllObservationAttributes(rows) {
  ...
  var obsAttributeHash = {},
      footnoteNumber = 0,
      configObsAttributes = [{"field":null,"label":""},{"field":null,"label":""}];
  if (configObsAttributes && configObsAttributes.length > 0) {
    configObsAttributes = configObsAttributes.map(function(obsAtt) {
      return obsAtt.field;
    });
...
function getObservationAttributeText(obsAttribute) {
    var configuredObsAttributes = [{"field":null,"label":""},{"field":null,"label":""}];
